...
//trainning speed 
#define DEFUALT_TRAINNING_POPULATION_SIZE 20
#define DEFUALT_TRAINNGNG_TIME_TO_LIVE 20.0f
#define DEFUALT_TRAINNING_SPEED_MULTIPLIER ((100.f/(DEFUALT_TRAINNING_POPULATION_SIZE*DEFUALT_TRAINNING_POPULATION_SIZE))*10.0f)
